...
RELAYER_CONTRACT_ADDRESS = "0xeEB8eFAd68491066B5c4150112645190430e0e05"
RELAYER_ACCOUNT: Account = Account.from_key(
    os.getenv(
        "PRIVATE_KEY",
...
def get_ethereum_client(ethereum_network: EthereumNetwork) -> EthereumClient:
    networks_with_node_url = {
        EthereumNetwork.RINKEBY: "https://rpc.ankr.com/eth_rinkeby",
        EthereumNetwork.GOERLI: "https://rpc.ankr.com/eth_goerli",
        EthereumNetwork.XDAI: "https://rpc.ankr.com/gnosis",
    }
...
def get_transaction(chain_id: int, safe_tx_hash: HexStr) -> Tuple[SafeTx, HexBytes]:
...
def relay_transaction(chain_id: int, safe_tx_hash: HexStr) -> HexStr:
    ...
    relayer_contract = ethereum_client.w3.eth.contract(
        address=RELAYER_CONTRACT_ADDRESS, abi=RELAYER_CONTRACT_ABI
    )
    ...
    tx_hash = ethereum_client.send_raw_transaction(signed_transaction.rawTransaction)
    return tx_hash
